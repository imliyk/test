    ...
    <el-container>
      ...
      <el-aside :width="asideWidth" style="min-height: 100vh;background-color: rgb(72, 84, 121);">
        <div style="height: 60px;color: #fefcfc;display: flex; align-items: center;justify-content: center;">
          ...
          <span class="logo-title" v-show="!isCollapse">波普特酒店工作系统</span>
        </div>
        ...
        <el-menu :collapse="isCollapse" :collapse-transition="false" router background-color="rgb(72, 84, 121)"
          ...
          <el-submenu>
            ...
            <el-menu-item index="/element">前台</el-menu-item>
            <el-menu-item>空调管理员</el-menu-item>
            <el-menu-item>酒店管理员</el-menu-item>
          </el-submenu>
...
export default {
  ...
  mounted(){
    request.get('/worker/selectAll').then(res =>{
      this.users = res.data
    })
  },  //数据库数据读取
